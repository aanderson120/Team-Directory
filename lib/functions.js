...
//                     }
//                     ).then((newEmployee) => {
//                         const newEmpDept = "What is the employee's department";
//                         const newEmpRole = "What is the employee's role";
//                         promptNewEmp(connection, newEmpDept, newEmpRole).then((roleId) => {
//                             if (!roleId) {
//                                 showMenu(connection);
//                             } else {
//                                 newEmployee.role_id = roleId;

//                                 const newMgr = "Who is their manager?";
//                                 promptMgr(connection, newMgr, true).then((managerId) => {
